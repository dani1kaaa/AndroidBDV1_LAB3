...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText.append(String.format("%s %s \n", getString(R.string.Введите_марку_автомобиля), getIntent().getStringExtra("model")));
        editText.append(String.format("%s %s \n", getString(R.string.Укажите_пол_владельца), getIntent().getStringExtra("gender")));
        editText.append(String.format("%s %s \n", getString(R.string.Выберите_цвет_авто), getIntent().getStringExtra("color")));
        editText.append(String.format("%s %s \n", getString(R.string.Страна_производитля), getIntent().getStringExtra("country")));
    }
